...
LABEL description="Red Hat AMQ 7.13.5 Jolokia Api Server"
LABEL maintainer="Howard Gao <hgao@redhat.com>"
LABEL version="7.13.5"
LABEL summary="Red Hat AMQ 7.13.5 Jolokia Api Server"
LABEL amq.broker.version="7.13.5.JAS.1.CR1"
LABEL com.redhat.component="amq-broker-jolokia-api-server-rhel9-container"
LABEL io.k8s.display-name="Red Hat AMQ 7.13.5 Jolokia Api Server"
