...
LABEL description="Red Hat AMQ 7.13.4 Jolokia Api Server"
LABEL maintainer="Howard Gao <hgao@redhat.com>"
LABEL version="7.13.4"
LABEL summary="Red Hat AMQ 7.13.4 Jolokia Api Server"
LABEL amq.broker.version="7.13.4.JAS.1.CR2"
LABEL com.redhat.component="amq-broker-jolokia-api-server-rhel9-container"
LABEL io.k8s.display-name="Red Hat AMQ 7.13.4 Jolokia Api Server"
